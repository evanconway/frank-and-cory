...
global.assemble_frank = dialog_get_updateable([
	...
	cory_get_dialog_step("Don't feel. Just think. Tell me what we were doing before the power outage.", CORY_EXPRESSION.NEUTRAL),
	...
	cory_get_dialog_step("That's right!", CORY_EXPRESSION.NEUTRAL),
	...
	cory_get_dialog_step("Now you're starting to sound like Frank again.", CORY_EXPRESSION.NEUTRAL),
	...
	cory_get_dialog_step("Sure, whatever. I just wanna get out of this studio.", CORY_EXPRESSION.NEUTRAL),
	frank_get_dialog_step("Alright, well, if you don't mind giving me a hand.", FRANK_EXPRESSION.UP),
	cory_get_dialog_step("Of course I'll help.", CORY_EXPRESSION.NEUTRAL),
	...
	cory_get_dialog_step("How did you even manage to take these off in the first place?", CORY_EXPRESSION.NEUTRAL),
...
on_click = function() {
	...
	global.updateable = dialog_get_updateable([
		frank_get_dialog_step("That looks familiar!", FRANK_EXPRESSION.RIGHT),
		cory_get_dialog_step("I agree.", CORY_EXPRESSION.NEUTRAL),
		cory_get_dialog_step("Let's fix you up!", CORY_EXPRESSION.NEUTRAL),
	], {
